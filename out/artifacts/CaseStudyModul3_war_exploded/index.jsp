...
<%--    <div class="container">--%>
<%--      <a class="navbar-brand" href="index.html">Dynamic sport shoes</a>--%>
...
<%--              &lt;%&ndash;                        &lt;%&ndash;%>--%>
<%--              &lt;%&ndash;                            if(session.getAttribute("username") != null){&ndash;%&gt;--%>
<%--              &lt;%&ndash;                        %>&ndash;%&gt;--%>
<%--              &lt;%&ndash;                        <a class="dropdown-item" >Hello, <%=session.getAttribute("username") %></a>&ndash;%&gt;--%>
<%--              &lt;%&ndash;                        <%} %>&ndash;%&gt;--%>
...
<%--      <p class="lead text-muted mb-0">content</p>--%>
<%--    </div>--%>
<%--  </section>--%>
<%--  <div class="container">--%>
<%--    <div class="row">--%>
...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <div class="fadeIn first">
            <img src="https://image.thanhnien.vn/768/uploaded/minhnguyet/2018_03_22/giaynhai_ftxm.jpg" id="icon" alt="User Icon" />
        </div>
